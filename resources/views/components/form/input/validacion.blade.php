...
<div class="relative">
<input x-model="{{$model}}"  {{$attributes->merge(['class' => 'dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30'])}}
    @input.debounce.500ms="{{$debounce}}"
    :class="{
    'dark:bg-dark-900 border-error-300 shadow-theme-xs focus:border-error-300 focus:ring-error-500/10 dark:border-error-700 dark:focus:border-error-800': {{$keyEval}} === true,
    'dark:bg-dark-900 border-success-300 shadow-theme-xs focus:border-success-300 focus:ring-success-500/10 dark:border-success-700 dark:focus:border-success-800': {{$keyEval}} === false
    }"
  type="text" placeholder="{{$placeholder}}" class="" />

    <span x-show="{{$keyEval}}==true" class="absolute top-1/2 right-3.5 -translate-y-1/2">
    ...
    <span x-show="{{$keyEval}}==false" class="absolute top-1/2 right-3.5 -translate-y-1/2">
