...
<div x-data="{
    ...
    x-data="{ open: false }" @open-regular-modal.window="open = true">
    ...
    <!-- Modal Content -->
    <div @click.stop class="relative w-full rounded-3xl bg-white dark:bg-gray-900 {{$maxw}}"
        ...
        <div>
            ...
            @isset($title)
                  <h4 class="font-semibold text-gray-800 mb-7 text-title-sm dark:text-white/90">{{$title}}</h4>
            @endisset
    ...
    Close
            ...
            <button
    class="inline-flex items-center justify-center font-medium gap-2 rounded-lg transition px-4 py-3 text-sm bg-brand-500 text-white shadow-theme-xs hover:bg-brand-600 disabled:bg-brand-300" type="button" @click="open = false"
    >
