...
@section('content')
                    ...
                    <div>
                        <div class="mb-5 sm:mb-8">
                            <h1 class="text-title-sm sm:text-title-md mb-2 font-semibold text-gray-800 dark:text-white/90">
                               {{___('app.login','Signin')}}
                            </h1>
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                               {{___('app.logininfo','Enter your email and password to sign in!')}} 
                            </p>
                        </div>
                        <div>
                            <div class="grid grid-cols-1 gap-3 sm:grid-cols-1 sm:gap-5">
                                <a href="{{ route('google.login') }}"
                                    ...
                                    {{___('app.logingoogle','Sign in with Google')}}
                                </a>
                            </div>
                                ...
                                <form @submit.prevent="login">
                                    <div class="space-y-5">
                                        ...
                                        <div>
                                            ...
                                            <input type="email" id="email" name="email" x-model="form.email" placeholder="info@gmail.com"
                                                class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                                        </div>
                                        <!-- Password -->
                                        <div>
                                            <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                                {{___('app.password','Password')}} <span class="text-error-500">*</span>
                                            </label>
                                            <div x-data="{ showPassword: false }" class="relative">
                                                <input :type="showPassword ? 'text' : 'password'"  x-model="form.password"
                                                    placeholder="{{___('app.passwordplaceholder','Ingresa tu contraseña')}}"
                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <a href="/" class="mb-4 block">
                            <img src="./images/logo/logo.png" alt="nickcyrus.dev" />
                        </a>
    ...
    return {
        ...
        async login() {
            ...
            this.message = '';
            try {
                const response = await fetch('{{route('check-api')}}', {
                    method: 'POST',
                    headers: {
